...
import com.projects.aquarium.dto.*;
...
import com.projects.aquarium.entity.ResponseStatus;
...
public class UserService {
    ...
    public ResponseDto signUp(SignupDto signupDto)  throws CustomException {
        ...
        User user = new User(signupDto.getFirstName(), signupDto.getLastName(), signupDto.getEmail(), Role.ROLE_USER, encryptedPassword );
